...
export default function PostDetailPage() {
  ...
  const handleLikePost = () => {
    ...
    if (!post) return;
    toggleLike(String(post.postId), post.isLiked || false);
  };
  ...
  const handleLikeComment = (commentId: number) => {
    ...
    toggleCommentLike({ postId: post.postId, commentId: comment.commentId, isLiked: comment.isLiked || false });
  };
  ...
  const handleBookmark = () => {
    ...
    if (!post) return;
    toggleScrap(String(post.postId), post.isBookmarked || false);
  };
