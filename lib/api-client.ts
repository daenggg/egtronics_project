...
export async function updatePost(id: string, payload: UpdatePostRequest): Promise<PostWithDetails> {
...
export async function updateMyProfile(payload: Partial<User>): Promise<string> {
